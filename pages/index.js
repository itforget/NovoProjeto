    ...
    <div>
      <div className='bg-[#062C26] flex items-center justify-between'>
        ...
        <div className='flex items-center gap-[80px] text-lg font-bold text-[#96a7a4] mr-[80px]'>
          <a className='hover:opacity-50' href='#SOBRE'>SOBRE</a>
          <a className='hover:opacity-50' href='#PROJETOS'>PROJETOS</a>
          <a className='border-[#6655a1] border-2 rounded-xl p-1 text-[#6655a1] hover:opacity-50' href='mailto:italcordeiro.s@gmail.com'>
            CONTATO
          </a>
        </div>
      </div>
      <div className={`bg-[#062C26] mx-[250px] my-10 ${styles.arrowContainer}`}>
